...
public static class QuantityServicesTests
{
    ...
    Check(customFaces[0].Quantity==2, "Custom mainDb-only quantity");
        ...
        // Assign quantity manually to front then adjust; for pure MFC logic call adjust directly to avoid enrichment misses noise
    ...
    // Orchestrator already exercised; legacy enrichment wrapper removed
