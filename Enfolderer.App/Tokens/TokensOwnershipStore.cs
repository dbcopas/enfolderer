...
/// <summary>
/// Persists token ownership as lines of "SET|COLLECTOR_NUMBER" in a plain text file.
/// </summary>
internal class TokensOwnershipStore
{
    private readonly string _filePath;
    private readonly HashSet<string> _owned = new(StringComparer.OrdinalIgnoreCase);

    public TokensOwnershipStore(string filePath)
    {
        _filePath = filePath;
        Load();
    }
